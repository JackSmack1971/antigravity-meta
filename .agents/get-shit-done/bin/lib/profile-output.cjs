...
const CLAUDE_MD_FALLBACKS = {
  ...
  skills: 'No project skills found. Add skills to any of: `.agents/skills/`, `.agents/skills/`, `.cursor/skills/`, or `.github/skills/` with a `SKILL.md` index file.',
};

// Directories where project skills may live (checked in order)
const SKILL_SEARCH_DIRS = ['.agents/skills', '.agents/skills', '.cursor/skills', '.github/skills'];
