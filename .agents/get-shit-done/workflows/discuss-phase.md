...
- Read and execute @.agents/get-shit-done/workflows/discuss-phase-power.md end-to-end
...
```bash
MAX_PASSES=$(node ".agents/get-shit-done/bin/gsd-tools.cjs" config-get workflow.max_discuss_passes 2>/dev/null || echo "3")
```
...
**Full step-by-step instructions:** @.agents/get-shit-done/workflows/discuss-phase-power.md
