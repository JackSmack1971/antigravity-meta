...
<reference>
@.agents/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `.agents/get-shit-done/references/user-profiling.md` to load:
