...
Load config from `{project-root}/.agents/bmad/core/config.yaml` and resolve:

- `project_name`, `output_folder`, `user_name`
- `communication_language`, `document_output_language`, `user_skill_level`
- `date` as a system-generated value
- Agent manifest path: `{project-root}/.agents/bmad/_config/agent-manifest.csv`

### Paths

- `agent_manifest_path` = `{project-root}/.agents/bmad/_config/agent-manifest.csv`
