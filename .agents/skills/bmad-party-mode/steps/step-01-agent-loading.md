...
- Agent manifest CSV is available at `{project-root}/.agents/bmad/_config/agent-manifest.csv`
...
Load and parse the agent manifest CSV from `{project-root}/.agents/bmad/_config/agent-manifest.csv`
