...
description: "Planificación basada en archivos estilo Manus, integrada en GSD + BMAD (Español)"
...
slash-commands:
  - name: plan
    description: "Iniciar planificación. Crea task_plan.md, findings.md, progress.md."
  - name: plan:status
    description: "Mostrar estado de planificación actual."
...
# Planning with Files — Edición GSD (Español)
...
Trabaja como Manus: archivos Markdown persistentes como memoria de trabajo en disco.
