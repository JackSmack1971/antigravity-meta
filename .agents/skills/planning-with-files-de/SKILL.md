...
description: "Manus-style dateibasierte Planung nativ in GSD + BMAD integriert (Deutsch)"
...
slash-commands:
  - name: plan
    description: "Manus-Planung starten. Erstellt task_plan.md, findings.md, progress.md."
  - name: plan:status
    description: "Aktuellen Planungsstatus anzeigen."
...
# Planning with Files — GSD Edition (Deutsch)
...
Arbeite wie Manus: persistente Markdown-Dateien als Arbeitsgedächtnis auf der Festplatte.
